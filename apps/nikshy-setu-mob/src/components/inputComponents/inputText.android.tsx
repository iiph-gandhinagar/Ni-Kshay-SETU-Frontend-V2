  ...
  return (
    ...
    >
      <TextInput
        ...
        style={componentStyles.TextInputInputComponent}
      ...
      <Row style={{ alignItems: 'center', alignContent: 'center' }}>
        ...
        >
          <Dropdown
            ...
            value={countryCode}
            // iconStyle={{ backgroundColor: "red", padding: 0, margin: 0 }}
        ...
        >
          <TextInput
            ...
            style={[
              componentStyles.TextInputInputComponent,
              { color: colors.BLACK_000000, alignContent: 'center' },
            ]}
            placeholder={transformText(
              (placeholder && placeholder) || `Enter ${label}`,
              'capitalizeFirstLetter'
